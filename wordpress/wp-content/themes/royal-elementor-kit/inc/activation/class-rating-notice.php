...
class REK_Rating_Notice {
    ...
    public function __construct() {
        $this->past_date = false == get_option('rek_maybe_later_time') ? strtotime( '-3 days' ) : strtotime('-5 days');
        // delete_option( 'rek_rating_dismiss_notice' );
        // delete_option('rek_maybe_later_time');
        // delete_option('rek_rating_already_rated');
