	...
	*/
	public function render_notice_content() {
		...
		<div class="welcome-message" style="<?php echo esc_attr($flex_attr); ?>">
			...
			<p>
				<?php echo sprintf( esc_html__( 'Royal Elementor Kit comes with %s with various designs to pick from.', 'royal-elementor-kit' ), '<strong><a href="https://demosites.royal-elementor-addons.com/elementor-templates/?ref=royal-elementor-theme-wellcome-banner" target="_blank">Elementor based 25+ sites library</a></strong>' ); ?>
				<br>
				<?php esc_html_e( 'Easily Customize every fundamental part of your WordPress site with Royal Elementor Theme Builder.', 'royal-elementor-kit' ); ?>
				<br>
				<?php echo sprintf( esc_html__( 'Including your %s etc..', 'royal-elementor-kit' ), '<strong>Header, Footer, Archives, Posts, Default Pages, 404 Pages,</strong>' ); ?>
			</p>
